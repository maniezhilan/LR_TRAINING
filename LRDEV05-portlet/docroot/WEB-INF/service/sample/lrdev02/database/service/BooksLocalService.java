...
public interface BooksLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BooksLocalServiceUtil} to access the books local service. Add custom service methods to {@link sample.lrdev02.database.service.impl.BooksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public sample.lrdev02.database.model.Books addBooks(
	...
	*/
	public sample.lrdev02.database.model.Books createBooks(long bookId);
	...
	* @throws SystemException if a system exception occurred
	*/
	public sample.lrdev02.database.model.Books deleteBooks(long bookId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public sample.lrdev02.database.model.Books deleteBooks(
		sample.lrdev02.database.model.Books books)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	...
	public sample.lrdev02.database.model.Books fetchBooks(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public sample.lrdev02.database.model.Books getBooks(long bookId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public sample.lrdev02.database.model.Books getBooksByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<sample.lrdev02.database.model.Books> getBookses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	* @throws SystemException if a system exception occurred
	*/
	public sample.lrdev02.database.model.Books updateBooks(
		sample.lrdev02.database.model.Books books)
		throws com.liferay.portal.kernel.exception.SystemException;

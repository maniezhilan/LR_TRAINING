...
package sample.lrdev02.database.service;
...
/**
 * The utility for the books local service. This utility wraps {@link sample.lrdev02.database.service.impl.BooksLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see sample.lrdev02.database.service.base.BooksLocalServiceBaseImpl
 * @see sample.lrdev02.database.service.impl.BooksLocalServiceImpl
 * @generated
 */
public class BooksLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link sample.lrdev02.database.service.impl.BooksLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static sample.lrdev02.database.model.Books addBooks(
		sample.lrdev02.database.model.Books books)
	...
	*/
	public static sample.lrdev02.database.model.Books createBooks(long bookId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static sample.lrdev02.database.model.Books deleteBooks(long bookId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static sample.lrdev02.database.model.Books deleteBooks(
		sample.lrdev02.database.model.Books books)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static sample.lrdev02.database.model.Books fetchBooks(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static sample.lrdev02.database.model.Books getBooks(long bookId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static sample.lrdev02.database.model.Books getBooksByUuidAndGroupId(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<sample.lrdev02.database.model.Books> getBookses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {

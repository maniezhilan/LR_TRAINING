...
public class BooksWrapper implements Books, ModelWrapper<Books> {
	...
	*/
	...
	public int compareTo(sample.lrdev02.database.model.Books books) {
	...
	public com.liferay.portal.model.CacheModel<sample.lrdev02.database.model.Books> toCacheModel() {
		return _books.toCacheModel();
	}

	public sample.lrdev02.database.model.Books toEscapedModel() {

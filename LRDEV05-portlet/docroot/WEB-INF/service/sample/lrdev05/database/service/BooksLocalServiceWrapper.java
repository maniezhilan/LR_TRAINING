...
public class BooksLocalServiceWrapper implements BooksLocalService,
	...
	*/
	...
	public sample.lrdev02.database.model.Books updateStatus(long userId,
	...
	public sample.lrdev02.database.model.Books getBooksInstance() {
		return _booksLocalService.getBooksInstance();
	}

	public java.util.List<sample.lrdev02.database.model.Books> getAllBooks(
		long companyId) {
	...
	public java.util.List<sample.lrdev02.database.model.Books> getBooksByUserId(
		long userId) {
	...
	public void deleteBooks(sample.lrdev02.database.model.Books book,
		long companyId) {

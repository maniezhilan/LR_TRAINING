...
public class BooksPersistenceImpl extends BasePersistenceImpl<Books>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP_AUTHOR = new FinderPath(BooksModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), String.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_R_S = new FinderPath(BooksModelImpl.ENTITY_CACHE_ENABLED,
			BooksModelImpl.FINDER_CACHE_ENABLED, BooksImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_R_S = new FinderPath(BooksModelImpl.ENTITY_CACHE_ENABLED,
			BooksModelImpl.FINDER_CACHE_ENABLED, BooksImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByR_S",
			new String[] { Long.class.getName(), Integer.class.getName() },
			BooksModelImpl.RESOURCEPRIMKEY_COLUMN_BITMASK |
			BooksModelImpl.STATUS_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_R_S = new FinderPath(BooksModelImpl.ENTITY_CACHE_ENABLED,
			BooksModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Books updateImpl(sample.lrdev05.database.model.Books books,
		...
		if (isNew || !BooksModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((booksModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(booksModelImpl.getOriginalResourcePrimKey()),
						Integer.valueOf(booksModelImpl.getOriginalStatus())
					};
				...
				args = new Object[] {
						Long.valueOf(booksModelImpl.getResourcePrimKey()),
						Integer.valueOf(booksModelImpl.getStatus())
					};
	...
	protected Books toUnwrappedModel(Books books) {
		...
		booksImpl.setResourcePrimKey(books.getResourcePrimKey());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Books> filterFindByGroupId(long groupId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Books> filterFindByGroupId(long groupId, int start, int end)
		throws SystemException {
	...
	public List<Books> filterFindByGroupId(long groupId, int start, int end,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_BOOKS_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_BOOKS_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_BOOKS_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(BooksModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				Books.class.getName(), _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN,
				groupId);
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, BooksImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, BooksImpl.class);
			}
			...
			return (List<Books>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books[] filterFindByGroupId_PrevAndNext(long bookId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchBooksException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(bookId, groupId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, books, groupId,
					orderByComparator, true);

			array[1] = books;

			array[2] = filterGetByGroupId_PrevAndNext(session, books, groupId,
					orderByComparator, false);
	...
	protected Books filterGetByGroupId_PrevAndNext(Session session,
		Books books, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Books> filterFindByGroup_Title(long groupId, String title)
		throws SystemException {
		return filterFindByGroup_Title(groupId, title, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Books> filterFindByGroup_Title(long groupId, String title,
		...
		return filterFindByGroup_Title(groupId, title, start, end, null);
	}
	...
	public List<Books> filterFindByGroup_Title(long groupId, String title,
		...
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroup_Title(groupId, title, start, end,
				orderByComparator);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books[] filterFindByGroup_Title_PrevAndNext(long bookId,
		long groupId, String title, OrderByComparator orderByComparator)
		throws NoSuchBooksException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroup_Title_PrevAndNext(bookId, groupId, title,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroup_Title_PrevAndNext(session, books,
					groupId, title, orderByComparator, true);

			array[1] = books;

			array[2] = filterGetByGroup_Title_PrevAndNext(session, books,
	...
	protected Books filterGetByGroup_Title_PrevAndNext(Session session,
		Books books, long groupId, String title,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Books> filterFindByGroup_Author(long groupId, String author)
		throws SystemException {
		return filterFindByGroup_Author(groupId, author, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Books> filterFindByGroup_Author(long groupId, String author,
		int start, int end) throws SystemException {
		return filterFindByGroup_Author(groupId, author, start, end, null);
	}
	...
	public List<Books> filterFindByGroup_Author(long groupId, String author,
		...
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroup_Author(groupId, author, start, end,
				orderByComparator);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books[] filterFindByGroup_Author_PrevAndNext(long bookId,
		long groupId, String author, OrderByComparator orderByComparator)
		throws NoSuchBooksException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroup_Author_PrevAndNext(bookId, groupId, author,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroup_Author_PrevAndNext(session, books,
					groupId, author, orderByComparator, true);

			array[1] = books;

			array[2] = filterGetByGroup_Author_PrevAndNext(session, books,
					groupId, author, orderByComparator, false);
	...
	protected Books filterGetByGroup_Author_PrevAndNext(Session session,
		Books books, long groupId, String author,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Books> findByR_S(long resourcePrimKey, int status)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Books> findByR_S(long resourcePrimKey, int status, int start,
		int end) throws SystemException {
	...
	public List<Books> findByR_S(long resourcePrimKey, int status, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Books books : list) {
				if ((resourcePrimKey != books.getResourcePrimKey()) ||
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books findByR_S_First(long resourcePrimKey, int status,
		OrderByComparator orderByComparator)
		throws NoSuchBooksException, SystemException {
		Books books = fetchByR_S_First(resourcePrimKey, status,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books fetchByR_S_First(long resourcePrimKey, int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<Books> list = findByR_S(resourcePrimKey, status, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books findByR_S_Last(long resourcePrimKey, int status,
		OrderByComparator orderByComparator)
		throws NoSuchBooksException, SystemException {
		Books books = fetchByR_S_Last(resourcePrimKey, status, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books fetchByR_S_Last(long resourcePrimKey, int status,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByR_S(resourcePrimKey, status);

		List<Books> list = findByR_S(resourcePrimKey, status, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Books[] findByR_S_PrevAndNext(long bookId, long resourcePrimKey,
		...
		try {
			...
			array[0] = getByR_S_PrevAndNext(session, books, resourcePrimKey,
					status, orderByComparator, true);

			array[1] = books;

			array[2] = getByR_S_PrevAndNext(session, books, resourcePrimKey,
	...
	protected Books getByR_S_PrevAndNext(Session session, Books books,
	...
	public void removeByR_S(long resourcePrimKey, int status)
		throws SystemException {
		for (Books books : findByR_S(resourcePrimKey, status)) {
			remove(books);
		}
	}
	...
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_BOOKS_WHERE);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int filterCountByGroup_Title(long groupId, String title)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByGroup_Title(groupId, title);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int filterCountByGroup_Author(long groupId, String author)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByGroup_Author(groupId, author);
		}
	...
	private static final String _FINDER_COLUMN_R_S_RESOURCEPRIMKEY_2 = "books.resourcePrimKey = ? AND ";
	private static final String _FINDER_COLUMN_R_S_STATUS_2 = "books.status = ?";
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "books.bookId";
	private static final String _FILTER_SQL_SELECT_BOOKS_WHERE = "SELECT DISTINCT {books.*} FROM TEST_Books books WHERE ";
	private static final String _FILTER_SQL_SELECT_BOOKS_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {TEST_Books.*} FROM (SELECT DISTINCT books.bookId FROM TEST_Books books WHERE ";
	private static final String _FILTER_SQL_SELECT_BOOKS_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN TEST_Books ON TEMP_TABLE.bookId = TEST_Books.bookId";
	private static final String _FILTER_SQL_COUNT_BOOKS_WHERE = "SELECT COUNT(DISTINCT books.bookId) AS COUNT_VALUE FROM TEST_Books books WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "books";
	private static final String _FILTER_ENTITY_TABLE = "TEST_Books";
	private static final String _ORDER_BY_ENTITY_ALIAS = "books.";
	private static final String _ORDER_BY_ENTITY_TABLE = "TEST_Books.";

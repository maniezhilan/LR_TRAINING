...
public class BooksLocalServiceClp implements BooksLocalService {
	public BooksLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName22 = "getBooksInstance";

		_methodParameterTypes22 = new String[] {  };

		_methodName23 = "getAllBooks";

		_methodParameterTypes23 = new String[] { "long" };

		_methodName24 = "getAllBooks";
		...
		_methodName26 = "getBooksByUserId";

		_methodParameterTypes26 = new String[] { "long" };

		_methodName27 = "deleteBooks";

		_methodParameterTypes27 = new String[] { "long", "long" };

		_methodName28 = "deleteBooks";

		_methodParameterTypes28 = new String[] {
				"sample.lrdev05.database.model.Books", "long"
			};

		_methodName29 = "getLatestBook";

		_methodParameterTypes29 = new String[] { "long", "int" };

		_methodName30 = "updateBooks";

		_methodParameterTypes30 = new String[] {
				"sample.lrdev05.database.model.Books", "long"
			};

		_methodName31 = "updateMyBean";
		...
		_methodName32 = "buildAuditMessage";
	...
	public sample.lrdev05.database.model.Books addBooks(
		...
		return (sample.lrdev05.database.model.Books)ClpSerializer.translateOutput(returnObj);
	}
	...
	public sample.lrdev05.database.model.Books getBooks(long bookId)
		...
		try {
			...
			if (t instanceof sample.lrdev05.database.NoSuchBooksException) {
				throw (sample.lrdev05.database.NoSuchBooksException)t;
			}
	...
	public java.util.List<sample.lrdev05.database.model.Books> getBookses(
		...
		return (java.util.List<sample.lrdev05.database.model.Books>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public sample.lrdev05.database.model.Books addBooks(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] {
						ClpSerializer.translateInput(booksParam),
	...
	public void deleteBooks(long booksId, long companyId) {
		try {
			_invokableLocalService.invokeMethod(_methodName27,
				_methodParameterTypes27, new Object[] { booksId, companyId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void deleteBooks(sample.lrdev05.database.model.Books book,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName28,
				...
				new Object[] { ClpSerializer.translateInput(book), companyId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void updateMyBean(sample.lrdev05.database.model.Books oldBean,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName31,
				...
				new Object[] {
					ClpSerializer.translateInput(oldBean),
					
				ClpSerializer.translateInput(newBean)
				});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

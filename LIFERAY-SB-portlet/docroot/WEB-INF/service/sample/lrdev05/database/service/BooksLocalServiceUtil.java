...
public class BooksLocalServiceUtil {
	...
	*/
	...
	public static sample.lrdev05.database.model.Books updateStatus(
	...
	public static sample.lrdev05.database.model.Books getBooksInstance() {
		return getService().getBooksInstance();
	}

	public static java.util.List<sample.lrdev05.database.model.Books> getAllBooks(
		long companyId) {
	...
	public static java.util.List<sample.lrdev05.database.model.Books> getBooksByUserId(
		long userId) {
	...
	public static void deleteBooks(sample.lrdev05.database.model.Books book,
		long companyId) {
		getService().deleteBooks(book, companyId);
	}

	public static sample.lrdev05.database.model.Books getLatestBook(
		long resourcePrimKey, int status)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getLatestBook(resourcePrimKey, status);
	}
	...
	public static void updateMyBean(
		sample.lrdev05.database.model.Books oldBean,
		sample.lrdev05.database.model.Books newBean) {
		getService().updateMyBean(oldBean, newBean);
	}

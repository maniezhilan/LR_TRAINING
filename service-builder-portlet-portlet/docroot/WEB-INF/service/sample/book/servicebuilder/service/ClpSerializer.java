...
import sample.book.servicebuilder.model.BookClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"service-builder-portlet-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "service-builder-portlet-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"sample.book.servicebuilder.model.impl.BookImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("sample.book.servicebuilder.NoSuchBookException")) {
			return new sample.book.servicebuilder.NoSuchBookException();
		}

...
public class BookLocalServiceClpInvoker {
	public BookLocalServiceClpInvoker() {
		...
		_methodParameterTypes15 = new String[] {
				"sample.book.servicebuilder.model.Book", "boolean"
			};
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return BookLocalServiceUtil.addBook((sample.book.servicebuilder.model.Book)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return BookLocalServiceUtil.deleteBook((sample.book.servicebuilder.model.Book)arguments[0]);
		}
		...
		if (_methodName14.equals(name) &&
			...
			return BookLocalServiceUtil.updateBook((sample.book.servicebuilder.model.Book)arguments[0]);
		}
